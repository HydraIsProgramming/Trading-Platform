...
var Slider = React68.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime50.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime49.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime49.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
